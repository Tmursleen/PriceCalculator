    ...
    public partial class MainWindow : Window
    {
      private Theme _theme = Theme.dark;
        ...
        private void PrittifyText()
        {
            ...
            {
                savedBills = string.Concat(savedBills, "Resturant Name: " + bill.Resturant + Environment.NewLine + "Price: " + 
                    bill.Price + Environment.NewLine + "Total: " + bill.Total + Environment.NewLine  + "Date: " + bill.Date + 
